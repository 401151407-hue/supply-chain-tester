...
>(({ side = 'right', className, children, ...props }, ref) => {
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:ring-offset-2">
          <X className="h-4 w-4" />
